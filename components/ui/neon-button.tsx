...
const buttonVariants = cva(
    "relative group border text-white mx-auto text-center rounded-full transition-transform active:scale-95",
    {
        variants: {
            variant: {
                default: "bg-blue-500/5 hover:bg-blue-500/10 border-blue-500/20 shadow-[0_0_10px_-5px_rgba(59,130,246,0.5)]",
